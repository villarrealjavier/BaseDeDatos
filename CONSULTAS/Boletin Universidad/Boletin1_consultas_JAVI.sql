...
--5
SELECT NOMBRE,APELLIDO,FECHA_NACIMIENTO FROM PERSONA WHERE FECHA_NACIMIENTO < TO_DATE('01/01/1975','DD/MM/YYYY');
...
--8
SELECT IDALUMNO,IDASIGNATURA FROM ALUMNO_ASIGNATURA WHERE IDASIGNATURA='150212' OR IDASIGNATURA='130113' OR IDASIGNATURA='150212' AND IDASIGNATURA='130113';

--9
SELECT CUATRIMESTRE FROM ASIGNATURA;
SELECT NOMBRE,CREDITOS FROM ASIGNATURA WHERE CUATRIMESTRE=2 AND CREDITOS!=6;
...
--12
SELECT NOMBRE FROM ASIGNATURA WHERE IDTITULACION LIKE '%'
