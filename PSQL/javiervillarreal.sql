...
SELECT CICLISMO.DEVOLVERCARRERA('KAS') FROM DUAL;
...
RESULTADO NUMBER:=0;
BEGIN
	SELECT AGREGARCICLISTA('LUCIA','DOMINICANA','19/JAN/1990',12,'Reynolds') INTO RESULTADO FROM DUAL;
END;
